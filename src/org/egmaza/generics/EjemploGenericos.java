package org.egmaza.generics;
import org.egmaza.poointerfaces.modelo.Cliente;
import org.egmaza.poointerfaces.modelo.ClientePremium;
...
public class EjemploGenericos {
    public static void main(String[] args) {
        ...
        clientes.add(new Cliente("Eduardo", "González"));
        Cliente eduardo = clientes.get(0);
        Cliente eduardo2 = clientes.iterator().next();
        Cliente[] clientesArreglo = {
                new Cliente("Eduardo", "González"),
                new Cliente("Juan", "López")
        };
        ...
        List<String> nombres = fromArrayToList(new String[]{"Andrés",
        "Pepe", "Lucy", "Bea" , "John"}, enterosArreglo);
        nombres.forEach(System.out::println);

        List<ClientePremium> clientesPremiumList = fromArrayToList(
                new ClientePremium[]{new ClientePremium("Paco", "Fernández"),
                new ClientePremium("Pandora", "López")
                });
