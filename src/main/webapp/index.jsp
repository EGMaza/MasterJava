...
<body>
   ...
   <form action="/webapp-form/registro" method="post">
      ...
      if(errores!=null && errores.containsKey("pais")){
         out.println("<div class='row mb-3 alert alert-danger col-sm-4' style='color: red;'>" + errores.get("pais") + "</div>");
      }
      %>
      <div class="row mb-3">
      ...
      if(errores!=null && errores.containsKey("lenguajes")){
         out.println("<div class='row mb-3 alert alert-danger col-sm-4' style='color: red;'>" + errores.get("lenguajes") + "</div>");
      }
      %>
      <div class="row mb-3">
      ...
      if(errores!=null && errores.containsKey("idioma")){
         out.println("<div class='row mb-3 alert alert-danger col-sm-4' style='color: red;'>" + errores.get("idioma") + "</div>");
      }
      %>
      <div class="row mb-3">
